...
/* 长度控制 — 硬性字数要求 */
const LENGTH_GUIDES = {
  smart:    '【硬性字数要求】根据主题和风格自适应，不设硬性限制。',
  inspire:  '【硬性字数要求】必须严格控制在50-100字之间，精简到每一句都有价值。不含标题和标签，正文纯字数必须达标。',
  standard: '【硬性字数要求】必须严格控制在150-300字之间，有完整的起承转合。不含标题和标签，正文纯字数必须达标，这是硬性指标。',
  deep:     '【硬性字数要求】必须严格控制在400-700字之间，有充分的分析和案例，至少分3段，每段至少3句话。不含标题和标签，正文纯字数必须达标，这是硬性指标。',
  long:     '【硬性字数要求】必须严格控制在800-1500字之间，是一篇完整的文章。至少分4-6段，每段至少4-5句话，结构完整。不含标题和标签，正文纯字数必须达标，这是硬性指标，非常重要！'
};
