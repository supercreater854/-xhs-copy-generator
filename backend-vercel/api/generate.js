/**
 * Vercel Serverless Function — 小红书 AI 文案生成
 * POST /api/generate  { "prompt": "产品名" }
 * GET  /api/generate?prompt=产品名
 */
...
module.exports = async (req, res) => {
  ...
  if (req.method === 'GET') {
    ...
    return res.status(405).json({ success: false, error: '仅支持 GET/POST' });
  }
